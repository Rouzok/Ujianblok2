...
<body class="bg-gray-800">
        ...
        <div class="flex justify-center m-5">
            ...
            <div class="mb-3 text-white">
                <a href="<?php echo site_url('admin/supplier/simpan') ?>" class="bg-gray-900 rounded-lg p-2 hover:bg-gray-700 text-white">Tambah Data</a>
            </div>
        </div>
        <div class="mx-20 text-white">
            <table id="table_id" class="table table-striped text-white">
                <thead>
                    <tr>
                        <th class="border text-center">ID Supplier</th>
                        <th class="border text-center">Nama Barang</th>
                        <th class="border text-center">Jenis Barang</th>
                        <th class="border text-center">Jumlah Masuk</th>
                        <th class="border text-center">Tanggal Masuk</th>
                ...
                <tbody>
                    <?php foreach ($supplier as $s) : ?>
                        <tr class="text-center">
                            ...
                            <td class="border">
                            <a class="group text-white" href="<?php echo site_url('admin/supplier/ubah/' . $s->id_supplier) ?>">
                                ...
                                <a class="group text-white" href="<?php echo site_url('admin/supplier/hapus/' . $s->id_supplier) ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="group-hover:text-white/70 w-6 h-6 inline duration-300">
