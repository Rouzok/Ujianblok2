...
class Barang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/tampil_barang', $data);
    }
    ...
    public function simpan()
    {
        ...
        if ($validasi->run()) { // menjalankan validasi form
            ...
            if ($insert) {
                echo '<script>alert("Data Berhasil Di Simpan");window.location.href = "' . site_url("admin/barang") . '";</script>';
            } else {
                echo '<script>alert("Data Gagal Disimpan");window.location.href = "' . site_url("admin/barang/simpan") . '";</script>';
            }
        }
        $this->load->view("admin/tambah_barang"); // menampilkan halaman tambah barang
    }

    public function ubah($id_barang = null) // menentukan parameter id_barang menjadi null / kosong
    {
        if (!isset($id_barang)) 
        redirect('admin/barang'); //logika jika id_barang yang dipanggil masih belum ada / kosong
        ...
        if ($validasi->run()) { // menjalankan validasi form
            ...
            if ($update) {
                echo '<script>alert("Data Berhasil Di Diubah");window.location.href = "' . site_url("admin/barang") . '";</script>';
            } else {
                echo '<script>alert("Data Gagal Di Ubah");window.location.href = "' . site_url("admin/barang/ubah") . '";</script>';
            }
        ...
        $this->load->view("admin/ubah_barang", $data); // memanggil data barang ke halaman ubah barang berdasarkan id_barang
    }
    ...
    public function hapus($id_barang = null) // menentukan parameter id_barang menjadi null / kosong
    {
        ...
        if ($barang->delete($id_barang)) { // menghapus data berdasarkan id_barang di db
            redirect('admin/barang'); //menampilkan halaman barang
